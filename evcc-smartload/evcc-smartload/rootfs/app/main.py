...
<body>
    <div class="container">
        ...
        <div class="doc-card" onclick="window.location.href='https://github.com/yourusername/ha-addon-smartprice'">
    ...
    def _generate_markdown_viewer(self, filename: str) -> str:
        ...
        try:
            ...
            content = f"# Fehler\n\nDokument konnte nicht geladen werden: {e}\n\nAlternativ siehe: https://github.com/yourusername/ha-addon-smartprice"
