...
# Note: the legacy _DeprecatedDQNAgent (35-action Q-table) was removed in v6.5.0.
# Replaced by ResidualRLAgent above. Old `/data/smartprice_rl_model.json` files
# from pre-Phase-8 installations are auto-detected and reset by ResidualRLAgent.load.
