...
Ab v4.2.0 werden Fahrzeuge über eine separate `vehicles.yaml` im Addon-Config-Verzeichnis konfiguriert.
...
|----------|--------------|
| `/health` | Health-Check (`{"status": "ok", "version": "4.2.0"}`) |
