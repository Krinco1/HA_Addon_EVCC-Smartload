...
Ab v4.2.1 werden Fahrzeuge über eine separate `vehicles.yaml` im Addon-Config-Verzeichnis konfiguriert.
...
|----------|--------------|
| `/health` | Health-Check (`{"status": "ok", "version": "4.2.1"}`) |
