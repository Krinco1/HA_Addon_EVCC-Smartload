...
![Version](https://img.shields.io/badge/version-4.3.11-blue.svg)
...
- 📊 SVG-Preischart mit integrierter Solar-Prognose
- 🧠 Transparentes Decision-Log (Was sehe ich? Was plane ich? Was mache ich?)
- 📱 Mobile-First Dashboard mit Auto-Refresh
